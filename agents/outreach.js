...
async function sendOutreach(lead, previewUrl, emailAddress, onProgress, subjectOverride, bodyOverride, trackingOpts, outreachType) {
  ...
  if (isHasWebsite && !bodyHtml.includes('See How It Works')) {
    bodyHtml += `<p style="margin:16px 0 20px"><a href="https://app.forgeaiagent.com/?hiw=1" style="display:inline-block;padding:12px 24px;background:#111;color:#fff;font-size:14px;font-weight:600;text-decoration:none;border-radius:6px">See How It Works</a></p>`;
  }
